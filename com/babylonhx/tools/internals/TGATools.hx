...
class TGATools {
	...
	private static var _TYPE_RGB:Int = 2;
	private static var _TYPE_GREY:Int = 3;
	private static var _TYPE_RLE_INDEXED:Int = 9;
	private static var _TYPE_RLE_RGB:Int = 10;
	private static var _TYPE_RLE_GREY:Int = 11;
	private static var _ORIGIN_MASK:Int = 0x30;
	private static var _ORIGIN_SHIFT:Int = 0x04;
	private static var _ORIGIN_BL:Int = 0x00;
	private static var _ORIGIN_BR:Int = 0x01;
	private static var _ORIGIN_UL:Int = 0x02;
	private static var _ORIGIN_UR:Int = 0x03;
