...
class Cylinder extends _Primitive {
	...
	public function new(id:String, scene:Scene, height:Float, diameterTop:Float, diameterBottom:Float, tessellation:Int, subdivisions:Int = 1, ?canBeRegenerated:Bool, ?mesh:Mesh) {
		this.height = height;
