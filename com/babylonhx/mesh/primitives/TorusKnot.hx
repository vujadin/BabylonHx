...
@:expose('BABYLON.TorusKnot') class TorusKnot extends _Primitive {
	...
	public function new(id:String, scene:Scene, radius:Float, tube:Float, radialSegments:Int, tubularSegments:Int, p:Float, q:Float, ?canBeRegenerated:Bool, ?mesh:Mesh) {
		this.radius = radius;
		this.tube = tube;
