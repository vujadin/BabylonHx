...
@:expose('BABYLON.QuadraticErrorSimplification') class QuadraticErrorSimplification implements ISimplifier {
	...
	private function runDecimation(settings:ISimplificationSettings, successCallback:Mesh->Void) {
	...
	private function initWithMesh(mesh:Mesh, cback:Dynamic) {
		if (mesh == null) {
			return;
		}
	...
	private function reconstructMesh():Mesh {
