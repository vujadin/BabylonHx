...
class DepthOfFieldBlurPostProcess extends BlurPostProcess {
	 ...
	 */
	public function new(name:String, scene:Scene, direction:Vector2, kernel:Float, options:Dynamic, camera:Camera, circleOfConfusion:PostProcess, imageToBlur:PostProcess = null, samplingMode:Int = Texture.BILINEAR_SAMPLINGMODE, ?engine:Engine, reusable:Bool = false, textureType:Int = Engine.TEXTURETYPE_UNSIGNED_INT) {
