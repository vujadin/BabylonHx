...
class LensRenderingPipeline extends PostProcessRenderPipeline {
	...
	*/
	...
	private function _createHighlightsPostProcess(ratio:Float) {
		...
		this._highlightsPostProcess.onApply = function(effect:Effect, _) {
	...
	private function _createDepthOfFieldPostProcess(ratio:Float) {
		...
		this._depthOfFieldPostProcess.onApply = function(effect:Effect, _) {
	...
	private function _createGrainTexture() {
		...
		var context = untyped this._grainTexture.getContext();
		...
		untyped this._grainTexture.update(false);
	}
