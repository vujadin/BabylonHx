...
@:expose('BABYLON.Collider') class Collider {
	...
	inline public function _collide(subMesh, pts:Array<Vector3>, indices:Array<Int>, indexStart:Int, indexEnd:Int, decal:Int):Void {
	...
	inline public function _getResponse(pos:Vector3, vel:Vector3):Void {
