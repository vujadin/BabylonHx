...
class SIMD {
	...
	public static function TransformCoordinatesToRefSIMD(vector:Vector3, transformation:Matrix, result:Vector3) {
	...
	public static function TransformCoordinatesFromFloatsToRefSIMD(x:Float, y:Float, z:Float, transformation:Matrix, result:Vector3) {
...
class SIMDMatrix {
	...
	public function multiplyToArraySIMD(other:Matrix, result:Matrix, offset:Int = 0) {
		var tm = (<any>this).m;
		var om = other.m;
	...
	public function invertToRefSIMD(other:Matrix):Matrix {
		var src = (<any>this).m;
		var dest = other.m;
	...
	public static function LookAtLHToRefSIMD(eyeRef:Vector3, targetRef:Vector3, upRef:Vector3, result:Matrix) {
		var out = result.m;
