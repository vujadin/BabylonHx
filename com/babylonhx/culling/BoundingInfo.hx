...
@:expose('BABYLON.BoundingInfo') class BoundingInfo {
    ...
    private static function extentsOverlap(min0:Float, max0:Float, min1:Float, max1:Float):Bool {
		return !(min0 > max1 || min1 > max0);
	}

    private static function axisOverlap(axis:Vector3, box0:BoundingBox, box1:BoundingBox):Bool {
