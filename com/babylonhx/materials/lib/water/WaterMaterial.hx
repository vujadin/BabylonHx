...
class WaterMaterial extends Material {
	...
	*/
	...
	public var refractionRTT(get, never):RenderTargetTexture;
	public var reflectionRTT(get, never):RenderTargetTexture;
	...
	*/	
	...
	private function get_refractionRTT():RenderTargetTexture {
		return _refractionRTT;
	}
	
	private function get_reflectionRTT():RenderTargetTexture {
