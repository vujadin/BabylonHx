...
class SimpleMaterialDefines extends MaterialDefines {
	...
	public static inline var DIRLIGHT0:Int = 17;
	public static inline var DIRLIGHT1:Int = 18;
	public static inline var DIRLIGHT2:Int = 19;
	public static inline var DIRLIGHT3:Int = 20;
	public static inline var POINTLIGHT0:Int = 21;
	public static inline var POINTLIGHT1:Int = 22;
	public static inline var POINTLIGHT2:Int = 23;
	public static inline var POINTLIGHT3:Int = 24;
	public static inline var SPECULARTERM:Int = 25;
