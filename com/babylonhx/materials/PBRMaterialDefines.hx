...
class PBRMaterialDefines extends MaterialDefines {
	...
	static public inline var METALLICROUGHNESSGSTOREINALPHA:Int = 60;
	static public inline var METALLICROUGHNESSGSTOREINGREEN:Int = 61;
	
	static public inline var SHADOWS:Int = 62;
	
	static public inline var CAMERACOLORCURVES:Int = 63;
	
	static public inline var SHADOWFULLFLOAT:Int = 64;
