...
class PBRMaterialDefines extends MaterialDefines {
	...
	static public inline var SHADOWS:Int = 59;
	
	static public inline var CAMERACOLORCURVES:Int = 60;
	
	static public inline var SHADOWFULLFLOAT:Int = 61;
