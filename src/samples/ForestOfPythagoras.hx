...
class ForestOfPythagoras {
	...
	public function new(scene:Scene) {
		...
		var woodTexture = new Wood(name + "tex", 512, scene);
		...
		var grassTexture = new Grass(name + "tex", 1024, scene);
