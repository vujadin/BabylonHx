...
class Particles3 {
	...
	public function new(scene:Scene) {
		...
		function createPs(emitter:Vector3, ps:ParticleSystem, color1:Color4, color2:Color4, colorDead:Color4) {			
			...
			ps.updateFunction = inline function(particles:Array<Particle>) {
