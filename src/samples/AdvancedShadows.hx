...
class AdvancedShadows {
	...
	public function new(scene:Scene) {
		...
		var ground03 = Mesh.CreateGround("Spotlight ESM", 24, 60, 1, scene, false);
		var ground04 = Mesh.CreateGround("Spotlight Blur ESM", 24, 60, 1, scene, false);
		...
		var ground13 = Mesh.CreateGround("Directional ESM", 24, 60, 1, scene, false);
		var ground14 = Mesh.CreateGround("Directional Blur ESM", 24, 60, 1, scene, false);
		...
		// --------- SPOTS -------------
		var light00 = new SpotLight("*spot00", new Vector3(-30, 20, -10), new Vector3(0, -1, 0.3), 1.2, 24, scene);
		var light01 = new SpotLight("*spot01", new Vector3(0, 20, -10), new Vector3(0, -1, 0.3), 1.2, 24, scene);
		var light02 = new SpotLight("*spot02", new Vector3(30, 20, -10), new Vector3(0, -1, 0.3), 1.2, 24, scene);
		var light03 = new SpotLight("*spot03", new Vector3(60, 20, -10), new Vector3(0, -1, 0.3), 1.2, 24, scene);
