...
class PointLightShadow {
	...
	public function new(scene:Scene) {
		...
		var knot = Mesh.CreateTorusKnot("knot", 4, 0.5, 128, 64, 4, 1, scene);	
		var torus = Mesh.CreateTorus("torus", 16, 2, 32, scene, false);
		...
		untyped containerMat.diffuseTexture.uScale = 10.0;
		untyped containerMat.diffuseTexture.vScale = 10.0;
		...
		particleSystem.emitter = new Vector3(0, -9.81, 0);
