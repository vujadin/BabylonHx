...
class ReflectionProbeTest {
	...
	public function new(scene:Scene) {
		...
		var generateSatelliteMaterial = function (root:Mesh, color:Color3, others:Array<Mesh>, probe:ReflectionProbe) {
		...
		// Satellite
		generateSatelliteMaterial(yellowSphere, Color3.Yellow(), [greenSphere, blueSphere, knot, mirror], probe);
		generateSatelliteMaterial(greenSphere, Color3.Green(), [yellowSphere, blueSphere, knot, mirror], probe);
		generateSatelliteMaterial(blueSphere, Color3.Blue(), [greenSphere, yellowSphere, knot, mirror], probe);
