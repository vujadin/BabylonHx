...
class HeightMap {
	...
	public function new(scene:Scene) {
		...
		groundMaterial.diffuseTexture = new Texture("assets/img/earth.jpg", scene);
		
		var ground = Mesh.CreateGroundFromHeightMap("ground", "assets/img/worldHeightMap.jpg", 200, 200, 250, 0, 10, scene, false);
