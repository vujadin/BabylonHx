...
class Materials {
	...
	public function new(scene:Scene) {
		...
		materialSphere3.diffuseTexture = new Texture("img/misc.jpg", scene);
		
		//Creation of a material with translated texture
		var materialSphere4 = new StandardMaterial("texture4", scene);
		materialSphere4.diffuseTexture = new Texture("img/misc.jpg", scene);
		...
		materialSphere5.diffuseTexture = new Texture("img/tree.png", scene);
		...
		materialSphere6.diffuseTexture = new Texture("img/tree.png", scene);
		...
		materialPlane.diffuseTexture = new Texture("img/grass.jpg", scene);
