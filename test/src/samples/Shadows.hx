...
class Shadows {
	...
	public function new(scene:Scene) {
		...
		// Ground
		var ground = Mesh.CreateGroundFromHeightMap("ground", "img/heightMap.png", 100, 100, 100, 0, 10, scene, false);
		var groundMaterial = new StandardMaterial("ground", scene);
		groundMaterial.diffuseTexture = new Texture("img/ground.jpg", scene);
